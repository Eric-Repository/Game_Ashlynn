...
public class ThirdPersonController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (playerController.colliderWithQuest4)
        {
            if (Input.GetKeyDown(KeyCode.F) && playerController.withinQuestRange == true && !playerController.questScript4.questWindow.activeSelf)
            {
                playerController.questScript4.interaction();
            }
            else if (Input.GetKeyDown(KeyCode.F) && playerController.withinQuestRange == true && playerController.questScript4.questWindow.activeSelf)
            {
                playerController.questScript4.CloseQuestWindow();
            }
        }

        if (Input.GetKeyDown(KeyCode.F) && playerController.withinPuzzleRange == true)
        {
            Puzzle.instance.showPuzzle();
        }
